torchrun --nproc_per_node 4 -m training_organized.main --batch-size=2 --lr=1e-5 --wd=0.1 --epochs=6 --workers=4 \
...
--name clipself_coco_6_save6_test1_eva_vitl14_24layers --downsample-factor 14 --det-image-size 896 \
--alpha 0.95